...
public class AuthenticationController {
    ...
    private final IamExternalsService externalAgentIamService;

    public AuthenticationController(UserCommandService userCommandService, IamExternalsService externalAgentIamService) {
