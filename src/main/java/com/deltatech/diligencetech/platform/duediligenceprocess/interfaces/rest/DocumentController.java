package com.deltatech.diligencetech.platform.duediligenceprocess.interfaces.rest;

import com.deltatech.diligencetech.platform.duediligenceprocess.domain.model.commands.DeleteDocumentCommand;
import com.deltatech.diligencetech.platform.duediligenceprocess.domain.model.queries.GetAllDocumentsQuery;
import com.deltatech.diligencetech.platform.duediligenceprocess.domain.model.queries.GetDocumentByIdQuery;
import com.deltatech.diligencetech.platform.duediligenceprocess.domain.model.queries.GetDocumentsByFolderIdQuery;
import com.deltatech.diligencetech.platform.duediligenceprocess.domain.services.DocumentCommandService;
import com.deltatech.diligencetech.platform.duediligenceprocess.domain.services.DocumentQueryService;
...
import com.deltatech.diligencetech.platform.duediligenceprocess.interfaces.rest.resources.InfoMessageResource;
import com.deltatech.diligencetech.platform.duediligenceprocess.interfaces.rest.resources.UpdateDocumentNameResource;
import com.deltatech.diligencetech.platform.duediligenceprocess.interfaces.rest.transform.CreateDocumentCommandFromResourceAssembler;
import com.deltatech.diligencetech.platform.duediligenceprocess.interfaces.rest.transform.DocumentResourceFromEntityAssembler;
import com.deltatech.diligencetech.platform.duediligenceprocess.interfaces.rest.transform.UpdateDocumentNameCommandFromResourceAssembler;
